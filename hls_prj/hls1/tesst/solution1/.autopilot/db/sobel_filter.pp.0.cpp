...
# 2 "sobel_filter.cpp" 2





static ap_uint<8> memory[(128 * 128)];
static ap_uint<8> processed_memory[(128 * 128)];

__attribute__((sdx_kernel("sobel_filter", 0))) void sobel_filter(ap_uint<8> data_in, ap_uint<1> write_enable, ap_uint<1> read_enable, ap_uint<8>& data_out, ap_uint<1>& done) {
#line 15 "C:/Users/User1/Desktop/hls1/tesst/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=sobel_filter
# 10 "sobel_filter.cpp"

#line 7 "C:/Users/User1/Desktop/hls1/tesst/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=sobel_filter
# 10 "sobel_filter.cpp"
...
#pragma HLS pipeline
 ...
 if (write_enable && !memory_filled) {
        ...
        VITIS_LOOP_37_1: for (int y = 1; y < 128 - 1; y++) {
            VITIS_LOOP_38_2: for (int x = 1; x < 128 - 1; x++) {
#pragma HLS pipeline
 int Gx_sum = 0;
                int Gy_sum = 0;

                VITIS_LOOP_43_3: for (int ky = -1; ky <= 1; ky++) {
                    VITIS_LOOP_44_4: for (int kx = -1; kx <= 1; kx++) {
#pragma HLS unroll
 int pixel = memory[(y + ky) * 128 + (x + kx)];
                ...
                processed_memory[y * 128 + x] = (magnitude > 255) ? (ap_uint<8>)255 : (ap_uint<8>)magnitude;
            }
        }
        processing_done = 1;
        done = 1;
